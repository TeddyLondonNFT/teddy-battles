...
<div className="text-left">
  ...
  onClick={() => selectNFT(nft)}
                 className="cursor-pointer border-2 border-yellow-600/60 bg-gradient-to-b from-[#2C2C2C]/90 to-[#141414]/95 hover:border-yellow-400 hover:from-[#383838]/95 hover:to-[#1A1A1A]/95 transition-all duration-200 p-4 rounded-xl shadow-lg shadow-black/40"
                >
